...
LOCK TABLES `hesla` WRITE;
/*!40000 ALTER TABLE `hesla` DISABLE KEYS */;
INSERT INTO `hesla` VALUES (1,'Boss','boss'),(2,'Others','others');
/*!40000 ALTER TABLE `hesla` ENABLE KEYS */;
UNLOCK TABLES;
